...
1. create a new file under `src/cocotbext/lin/callbacks/bsv.py`
...
The current version of lin supports reset check and simple rw_test with foreground and background read/write combinations.
There are a bunch of additional tests that are normally written for checking registers.
To contribute a new test:
1. Add your test to `src/cocotbext/lin/testcases` folder
2. Submit a PR.
